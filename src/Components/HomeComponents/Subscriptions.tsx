...
const Subscriptions = () => {
    ...
    return (
        <div className="w-[80vw] lg:w-[60vw] mx-auto rounded-md h-[330px] font-serif bg-gradient-to-b from-green-600 to-blue-400 shadow-2xl shadow-blue-700 p-5 my-36" data-aos="zoom-in-left" data-aos-offset="10" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="false">
