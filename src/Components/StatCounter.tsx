        ...
        <div className='w-[85vw] mx-auto flex flex-col lg:flex-row justify-center items-center mt-40 mb-20'>
            ...
            <div className='flex gap-12 h-[200px] md:h-[250px] lg:h-[200px] border-b lg:border-b-0 lg:border-r md:pr-5 md:gap-r-0 lg:pr-0'>
                ...
                <div className='border-r w-[200px] md:w-[270px] h-[200px] md:h-[250px] px-3 py-5 md:p-12 lg:h-[200px] lg:w-[210px] lg:p-5'>
                    <TiGroup className='h-24 w-24 rounded-full bg-green-200 border-8 border-green-100 p-5 text-green-700' />
                    <h1 className='text-4xl font-semibold'>100,000+</h1>
                ...
                <div className='w-[170px] h-[200px] md:w-[200px] md:h-[300px] p-5 md:p-12 lg:h-[200px] lg:w-[210px] lg:p-5'>
                    <MdOutlineTravelExplore className='h-24 w-24 rounded-full bg-green-200 border-8 border-green-100 p-5 text-green-700' />
            ...
            <div className='flex gap-12 md:pl-5 md:gap-l-0 h-[200px]'>
                <div className='border-r w-[200px] md:w-[230px] h-[200px] md:h-[250px] px-3 py-5 md:px-4 md:py-12 lg:h-[200px] lg:w-[210px] lg:p-5'>
                    <GiHiking className='h-24 w-24 rounded-full bg-green-200 border-8 border-green-100 p-5 text-green-700' />
                    <h1 className='text-4xl font-semibold'>10,000+</h1>
                ...
                <div className='w-[170px] h-[200px] p-5 md:w-[200px] md:h-[300px] md:p-12 lg:h-[200px] lg:p-5 lg:w-[210px]'>
                    <RiHotelFill className='h-24 w-24 rounded-full bg-green-200 border-8 border-green-100 p-5 text-green-700' />
